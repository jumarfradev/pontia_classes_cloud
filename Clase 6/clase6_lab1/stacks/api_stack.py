        ...
        **kwargs
        ...
        self.api = apigateway.RestApi(
            ...
            default_cors_preflight_options=apigateway.CorsOptions(
                ...
                allow_headers=["Content-Type", "Authorization", "X-Amz-Date", "X-Amz-Security-Token", "filename"],
        ...
        # Exportar también el ID del API para referencias cruzadas
        cdk.CfnOutput(
            self,
            "ApiId",
            value=self.api.rest_api_id,
            export_name=f"{lab_name}-api-id",
        )
